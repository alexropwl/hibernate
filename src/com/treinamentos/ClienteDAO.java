...
public class ClienteDAO {
	...
	public Cliente findById(java.math.BigDecimal id) {
		...
		try {
			Cliente instance = (Cliente) sessionFactory.getCurrentSession().get("com.treinamentos.Cliente", id);
			if (instance == null) {
	...
	public List findByExample(Cliente instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.treinamentos.Cliente")
