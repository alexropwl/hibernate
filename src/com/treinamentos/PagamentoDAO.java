 ...
 * @see com.treinamentos.Pagamento
...
public class PagamentoDAO {
	...
	public Pagamento findById(com.treinamentos.PagamentoId id) {
		log.debug("getting Pagamento instance with id: " + id);
		try {
			Pagamento instance = (Pagamento) sessionFactory.getCurrentSession().get("com.treinamentos.Pagamento", id);
			if (instance == null) {
	...
	public List findByExample(Pagamento instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.treinamentos.Pagamento")
